...
def main(_):
    ...
    **********************************
    '''
    #networks
    problem, net_config, net_assignments = util.get_config('lasso_train', net_name="RNNprop", mnist_classes=1, l1_weight=0.005, stddev=0.1)
    problem2, net_config2, net_assignments2 = util.get_config('lasso_train', net_name="RNNprop", mnist_classes=2, l1_weight=0.005, stddev=0.5)
    problem3, net_config3, net_assignments3 = util.get_config('lasso_train', net_name="RNNprop", mnist_classes=3, l1_weight=0.005, stddev=1)
