...
def main(_):
    ...
    **********************************
    '''
    #networks
    problem, net_config, net_assignments = util.get_config('rastrigin_vary_alpha', net_name="RNNprop", mnist_classes=1, l1_weight=1, stddev=0.1)
    problem2, net_config2, net_assignments2 = util.get_config('rastrigin_vary_alpha', net_name="RNNprop", mnist_classes=2, l1_weight=0.5, stddev=0.5)
    problem3, net_config3, net_assignments3 = util.get_config('rastrigin_vary_alpha', net_name="RNNprop", mnist_classes=3, l1_weight=2, stddev=1)
    ...
    ********************************
    ...
    with ms.MonitoredSession() as sess:
        ...
        ********************************
        ...
        ops2=[step2, update2, opt_var2, cost_op2, assign_func_opt2, apply_grad2, val_opt_grad2, compute_grad2, step_SGD2, seq_step2, reset2, assign_func2, var_x2]
        ops3=[step3, update3, opt_var3, cost_op3, assign_func_opt3, apply_grad3, val_opt_grad3, compute_grad3, step_SGD3, seq_step3, reset3, assign_func3, var_x3]
